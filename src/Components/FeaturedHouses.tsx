    ...
    return (
      <div>
        <div className="flex justify-between p-4">
          {Cookies.get("loggedIn") === "true" ? <label className="bottom-0 top-0 flex text-2xl font-semibold items-center">Featured Houses</label> : <label className="bottom-0 top-0 flex text-2xl font-semibold items-center">Recent Houses</label>}
